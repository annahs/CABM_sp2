...
parser.add_argument('analysis_start', help='Date for first config file in batch - format YYYY-MM-DD ',type=SP2_utilities.valid_date)
parser.add_argument('analysis_end', help='Date for final config file in batch - format YYYY-MM-DD ',type=SP2_utilities.valid_date)
